...
class Config:
    def __init__(self, test_flag):
        ...
        self.DME_master_hybrid_sde_path = self.CCSP_sde_path + r"\CCSP.GIS.DME_master_hybrid" # used for template

        #self.DME_master_hybrid_gdb_path = r"C:\temp\CCSP_working.gdb\DME_master_hybrid" # only works with append
